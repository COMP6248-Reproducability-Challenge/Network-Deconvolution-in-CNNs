...
if __name__ == '__main__':
    ...
    if args.arch == 'vgg16':
        net = VGG('VGG16',batchnorm=args.batchnorm,num_classes=args.num_outputs, deconv=args.deconv,delinear=args.delinear,channel_deconv=args.channel_deconv)

    if args.arch == 'vgg13':
        net = VGG('VGG13',num_classes=args.num_outputs, deconv=args.deconv,delinear=args.delinear,channel_deconv=args.channel_deconv)

    if args.arch == 'vgg11':
        net = VGG('VGG11',batchnorm=args.batchnorm,num_classes=args.num_outputs, deconv=args.deconv,delinear=args.delinear,channel_deconv=args.channel_deconv)
    ...
    if args.arch == 'MySimpleCnn1':
        from models.simple import *
        net = MySimpleCnn1(channels_in=args.in_planes, kernel_size=args.input_size, num_outputs=10)

    if args.arch == 'MySimpleCnn2':
        from models.simple import *
        net = MySimpleCnn2(channels_in=args.in_planes, kernel_size=args.input_size, num_outputs=10)

    if args.arch == 'MySimpleCnn3':
        from models.simple import *
        net = MySimpleCnn3(channels_in=args.in_planes, kernel_size=args.input_size, num_outputs=args.num_outputs)
